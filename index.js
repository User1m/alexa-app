...
alexa.request = function (json) {
  ...
  if (this.data.context) {
    this.userId = (this.data.context.System.user && this.data.context.System.user.userId) ? this.data.context.System.user.userId : undefined;
...
alexa.session = function (session) {
  ...
  if (isAvailable) {
    ...
    // @deprecated
    this.details.userId = (this.details.user && this.details.user.userId) ? this.details.user.userId : null;
    // @deprecated
    this.details.accessToken = (this.details.user && this.details.user.accessToken) ? this.details.user.accessToken : null;
